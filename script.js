...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init(); //will not use this class as an object in future, just need one method
    ...
    value: function bindTriggers(container, items, counter) {
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== items.length - 2) {
          ...
          items[counter].style.display = 'flex'; // show last card

          items[items.length - 1].remove(); // remove click to show card
        }
      });
    }
  }, {
    ...
    value: function init() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation(); // user downloads a file
    ...
    value: function initMask() {
      ...
      function createMask(event) {
        var matrix = '+1 (___) ___-____',
            ...
            // из матрицы получаем не цифровые значения-->статичное значение
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          var blockedElem = btn.closest('.module__video-item').nextElementSibling; //each btn/ i - num of btn
        ...
        btn.addEventListener('click', function () {
          ...
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            _this.activeBtn = btn; // btn user clicked
    ...
    value: function bindCloseBtn() {
      ...
      this.close.addEventListener('click', function () {
        _this2.overlay.style.display = 'none'; // we also need to stop(pause) a video
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedElem = this.activeBtn.closest('.module__video-item').nextElementSibling; // we get closest elem module__video-item_3 -> then next elem - locked video here

        var playBtn = this.activeBtn.querySelector('svg').cloneNode(true); // true -> глубокое копирование
...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns)); // gets access to page, btns   
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      if (n > this.slides.length) {
        //> number of slides, return to the beginning
        this.slideIndex = 1;
      }
  ...
  return MainSlider;
}(_slider__WEBPACK_IMPORTED_MODULE_9__["default"]); // click on the element => slideindex = 1, showSlides(1)
      ...
      this.prev.addEventListener('click', function () {
        ...
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.slides[i].tagName !== 'BUTTON') {
            var active = _this2.slides[i]; // last slide goes before the 1st one
